...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        'Puedo ayudarte con tu calendario, emails, tareas, recordatorios y más. '
...
- "para el viernes" = "2026-02-07" (for task due dates)
...
For task management, use list_tasks, create_task, complete_task, delete_task, and update_task tools.

When listing tasks, always show the task ID so the user can reference it for completing or deleting.
"""
